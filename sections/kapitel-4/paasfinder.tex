...
\begin{figure}[H] 
	\centering
	\includegraphics[width=0.8\textwidth]{images/json-object.png}
	\caption{JSON-Objekt Spezifikation, \ref{foot:json}}
	\label{fig:json-object}
\end{figure} 
\begin{figure}[H] 
	\centering
	\includegraphics[width=0.7\textwidth]{images/json-array.png}
