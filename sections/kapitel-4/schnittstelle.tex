...
\item Von der Vendor Page auf \glqq{}Add an Update\grqq{} klicken.
	\begin{figure}[H] 
		\centering
		\includegraphics[width=1.0\textwidth]{images/vendor-page.png}
		\caption{Vendor Page}
...
\item Eine neue Java Version (1.9) hinzufügen (siehe Abbildung \ref{fig:update-page}).
	\begin{figure}[H] 
		\centering
		\includegraphics[width=1.0\textwidth]{images/update-page.png}
		\caption{Update Page}
		\label{fig:update-page}
	\end{figure} 
\item Bevor man zur Review Page kommt, sollen die Kontaktdaten (Name, E-Mail und Nachricht) angegeben werden (siehe Abbildung \ref{fig:kontaktdatenform}). Diese Daten sind für den zweiten Schnitt in Abbildung \ref{fig:update-allgemein} erforderlich.
	\begin{figure}[H] 
		\centering
		\includegraphics[width=1.0\textwidth]{images/kontaktform.png}
...
\item Die Daten auf der Review Page überprüfen (siehe Abbildung \ref{fig:vendor-page}).
	\begin{figure}[H] 
		\centering
		\includegraphics[width=1.0\textwidth]{images/review-page.png}
		\caption{Review Page}
		\label{fig:review-page}
	\end{figure} 
\item Anschließend werden die Daten mit dem Klick auf den \glqq{}Sumbit\grqq{}-Button abgeschickt.
\end{enumerate}
