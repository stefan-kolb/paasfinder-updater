\section{Grundlagen von Expertensystemen}\label{sec:Expertensysteme}
...
\end{itemize}
Es ist auch wichtig anzumerken, dass die Begriffe \grqq{}Künstliche Intelligenz\grqq{}, \grqq{}Wissensbasiertes System\grqq{} und \grqq{}Expertensystem\grqq{} in einer engen Beziehung zueinander stehen. Haun gibt eine systematische Abgrenzung dieser Begriffe, die sich folgendermaßen beschreiben lässt \cite[S.30]{haun2000}:
\begin{itemize}
...
\item \textit{Wissensbasierte Systeme} sind eine Teilmenge der Anwendungen der künstlichen Intelligenz. Sie wenden die Wissensverarbeitung auf ein konkretes Aufgabengebiet an und verwalten allgemeines Wissen explizit und getrennt von dem Rest des Systems.
...
\end{itemize}
Graphisch lässt sich die vorliegende Abgrenzung in der Abbildung \ref{Abgrenzung} darstellen:
\begin{figure}[H] 
	\centering
...
\end{itemize}
Ein gutes Beispiel hinsichtlich der Gefahr, dass Expertenwissen verloren gehen kann, wird in \cite{gebus2009}[S.94] vorgestellt. Gebus nimmt den Bezug auf die sogenannte Baby-Boomgeneration, die bald in die Rente geht. Infolgedessen verlassen gleichzeitig viele Experten Unternehmen. Damit geht ebenso das Expertenwissen verloren.\\
