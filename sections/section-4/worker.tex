...
Generell lässt sich der Ablauf gemäß Abbildung \ref{fig:worker} folgendermaßen beschreiben: Als Erstes werden die Daten von der Wissenserfassungsmethode an den UpdateService gesendet. Darauffolgend werden sie vom UpdateService verarbeitet und für den UpdateClient vorbereitet. Im nächsten Schritt wird die Aufgabe der Datenübermittlung an den UpdateClient delegiert. Dieser erstellt die Anfrage an die Wissensbasis und teilt deren Antwort dem UpdateService mit. Anschließend verschickt der UpdateService die Rückmeldung an die Wissenserfassungsmethode.\\ 
